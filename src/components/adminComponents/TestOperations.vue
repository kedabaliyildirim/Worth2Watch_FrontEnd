  ...
  <div class="adminContentHeader">
    ...
    <div class="testingOperations">
      ...
      <div class="testOperation">
        <button @click="initializeContentDatabaseTest" :disabled="contentDatabaseTestStatus === 'ongoing'">
      ...
      <!-- Admin Database Test -->
      <div class="testOperation">
        <button @click="initializeAdminDatabaseTest" :disabled="adminDatabaseTestStatus === 'ongoing'">
      ...
      <div class="testOperation">
        <button @click="initializeCommentDatabaseTest" :disabled="commentDatabaseTestStatus === 'ongoing'">
      ...
      <div class="testOperation">
        <button @click="initializeServerConnectionTest" :disabled="serverConnectionTestStatus === 'ongoing'">
